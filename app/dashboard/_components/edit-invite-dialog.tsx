...
export function EditInviteDialog({
    ...
    const handleUpdateInvite = async () => {
        ...
        try {
            ...
            showSuccessToast("Invite updated successfully!", "New emails will receive an invitation email.");
            onClose();
        } catch {
        ...
        <Dialog open={isOpen} onOpenChange={handleClose}>
            <DialogContent className="max-w-2xl">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Update the email addresses for "{invite.fileName}". New emails will receive an invitation email.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="space-y-4">
                    ...
                    {/* Error Alert */}
                    {error && (
                        <Alert color="danger" variant="faded" className="mb-4">
                            {error}
                        </Alert>
                    )}
